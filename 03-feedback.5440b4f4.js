...
form.addEventListener("input", (0, _lodashThrottleDefault.default)(storeInput, 500));
form.addEventListener("click", onSubmitForm);
function storeInput(event) {
    if (event.target.nodeName === "INPUT") feedbackFormState.email = event.target.value;
    if (event.target.nodeName === "TEXTAREA") feedbackFormState.message = event.target.value;
    try {
